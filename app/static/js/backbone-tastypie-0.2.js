...
(function( undefined ) {
    ...
    // Use doGet:false to forbid get after Tastipye API.
        var doGet = true;
        if (options.doGet ==false) {
            doGet = false;
        }
		if ( (doGet &&( method === 'create' && Backbone.Tastypie.doGetOnEmptyPostResponse ) ||
			( method === 'update' && Backbone.Tastypie.doGetOnEmptyPutResponse )) || options.forceGet ) {
